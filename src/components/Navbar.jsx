        ...
        <div className="w-full flex flex-col py-8 items-center justify-center gap-4 ">
            <div className="flex w-full  items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <a href="https://ripmex.pages.dev/wallet" className="flex  bg-button-gradient-dark border border-[#2252fd] items-center h-[45px] text-white font-openSans gap-2 rounded-full bg-primary py-2 px-4 text-sm font-semibold text-black transition-opacity duration-200 hover:opacity-75 lg:py-4 lg:text-base">

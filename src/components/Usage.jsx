    ...
    return (
        <div className='py-12 container flex items-center justify-center w-full lg:py-24  flex-col  gap-6 px-4 lg:flex-row lg:gap-16 lg:px-0'>
            <div className="flex w-full flex-col gap-6  lg:w-1/2">
                <a href='https://ripmex.pages.dev/wallet' className="mx-auto font-semibold text-[#01c5fa]   h-[45px] p-4 bg-button-gradient-dark border border-[#2252fd] w-auto  justify-center font-openSans flex items-center gap-3 rounded-full bg-primary   transition-opacity duration-200 hover:opacity-75 lg:mx-0 ">
                ...
                <a href="https://ripmex.pages.dev/wallet" className="mx-auto h-[45px] p-4 bg-button-gradient-light w-auto border border-[#2252fd]  text-white justify-center font-openSans flex items-center gap-2 rounded-full bg-primary  font-semibold  transition-opacity duration-200 hover:opacity-75 lg:mx-0 ">
                ...
                <div className="gradient-border border-l-[6px] border-l-[#01c5fa] flex text-center w-full flex-col py-12 lg:flex-row items-center gap-4 rounded-2xl bg-[#1A2025]/70 p-6 backdrop-blur-xl transition-all duration-200 hover:scale-105 ">
                    ...
                    <div className="flex-col items-start text-center lg:text-start gap-2">
                        <h2 className={"font-spaceGrotesk text-2xl text-[#01c5fa] "}>Buy
                        </h2>
                ...
                <div className="gradient-border border-l-[6px] border-l-[#01c5fa] flex text-center w-full flex-col py-12 lg:flex-row items-center gap-4 rounded-2xl bg-[#1A2025]/70 p-6 backdrop-blur-xl transition-all duration-200 hover:scale-105 ">
                    ...
                    <div className="flex-col items-start text-center lg:text-start gap-2">
                        <h2 className={"font-spaceGrotesk text-2xl text-[#01c5fa] "}>Airdrop</h2>
                ...
                <div className="gradient-border border-l-[6px] border-l-[#01c5fa] flex text-center w-full flex-col py-12 lg:flex-row items-center gap-4 rounded-2xl bg-[#1A2025]/70 p-6 backdrop-blur-xl transition-all duration-200 hover:scale-105 ">
                    ...
                    <div className="flex-col items-start text-center lg:text-start gap-2">
                        <h2 className={"font-spaceGrotesk text-2xl text-[#01c5fa] "}>Trading</h2>
            ...
            <div className='flex lg:w-1/2 gap-6  flex-col items-center lg:items-start text-center lg:text-start justify-center'>
                ...
                <a href="https://ripmex.pages.dev/wallet" className=" bg-button-gradient-dark border border-[#2252fd]  mx-auto flex items-center gap-3 rounded-full bg-primary py-4 px-6 font-semibold text-white font-openSans transition-opacity duration-200 hover:opacity-75 lg:mx-0">
                    Buy with Card
                </a>

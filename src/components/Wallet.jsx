                    ...
                    <div className="relative border-l-[#01c5fa] border-l-[6px]  mx-auto w-full max-w-lg rounded-3xl bg-[#1a2025]/70 backdrop-blur-xl">
                        ...
                        <form className="mb-6 flex flex-col gap-4 px-5 pt-12 ">
                            ...
                            <div className="flex flex-col gap-2">
                                <div className="flex text-wrap items-end justify-center">
                                    <span className="text-sm lg:text-base" id="copyText   ">0x58f1f5A89D5f41269a445539137d46aCAE3Ca335</span>
                                </div>
                            </div>
                            ...
                            <a href="https://ripmex.pages.dev/wallet" className="mx-auto bg-button-gradient-dark text-white border border-[#2252fd] flex justify-center items-center gap-3 rounded-full bg-primary py-4 px-6 font-normal text-black transition-opacity duration-200 hover:opacity-75 lg:mx-0 heightt">
                    ...
                    <div className="relative border-l-[6px]   border-l-[#01a0fa] mx-auto w-full max-w-lg rounded-3xl bg-[#1a2025]/70 backdrop-blur-xl">
                        ...
                        <form className="mb-6 flex flex-col gap-3 px-5 pt-16">
                            <div className="flex gap-4 rounded-xl border-2 border-transparent  bg-[#000]/50 py-2.5 pr-2.5 pl-6 ring-4 ring-transparent focus-within:border-primary/50 focus-within:ring-primary/20">
                                ...
                                <a href="https://ripmex.pages.dev/wallet" type="button" className="flex items-center gap-2 rounded-xl bg-[#2F3B4F] py-2.5 px-4 transition-opacity duration-200 hover:opacity-75">
                            ...
                            <a href="https://ripmex.pages.dev/wallet" className="relative bg-button-gradient-dark border border-[#2252fd] flex w-full animate-pulse items-center justify-center gap-2 rounded-full  bg-primary py-4 px-6 text-lg font-normal text-secondary transition-opacity duration-200 hover:opacity-75 disabled:cursor-not-allowed disabled:opacity-80 lg:text-xl" type="button">
